...
const RemoveObject = () => {
  ...
  return (
    ...
    <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <button disabled={loading} className='bg-gradient-to-r from-[#417DF6] to-[#8E37EB] w-full flex justify-center items-center gap-2 text-white font-medium px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
          {
            loading ? <span className='w-4 h-4 my-1 rounde-full border-2 border-t-transparent animate-spin'></span> :  <Scissors className='w-5' /> 
          }
          Remove Object
        </button>
