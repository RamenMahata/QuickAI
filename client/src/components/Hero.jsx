...
const Hero = () => {
    ...
    return (
        ...
        <div className='text-center mb-6 '>
            ...
            <p className='mt-4 max-w-xs sm:max-w-lg 2xl:max-w-xl m-auto max-sm:text-sm text-gray-600'>Generate engaging blog titles, write articles, and create stunning visuals with our AI-powered tools.</p>
        </div>
